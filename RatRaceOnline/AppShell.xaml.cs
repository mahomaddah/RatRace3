    ...
    public partial class AppShell : Shell
    {
        ...
        public void getAnewGameData()
        {
            ...
            SelectLevelViewModel.ImageCollection.Add(new LevelModel
            {
                ...
                LearnedByWinMessage = "Erdem learned that investing in strong assets and using the passive income to upgrade your lifestyle is ideal. But as humans, if you truly love something — like a dream bike — and you're financially stable, delaying it may backfire. You might panic-sell your investments at the first correction just to chase that dream Bike later. Balance is the key.",
                LearnedByLoseMessage = "From this loss, Erdem learned the difference between good and bad debt. Some low-interest debts may be worth keeping — especially when inflation is high. But paying them off early increases your monthly cash flow, giving you more freedom to invest consistently.",
            ...
            SelectLevelViewModel.ImageCollection.Add(new LevelModel
            {
                ...
                LearnedByWinMessage = "The young investor learned that fundamentals matter far more than short-term price moves. If you own a solid company with money you won’t need soon, even a sharp drop doesn’t shake you. In fact, you can buy more or simply hold with a clear mind — that’s the power of long-term thinking.",
                LearnedByLoseMessage = "From this loss,The young investor learned that even making quick profits from low-quality investments can be dangerous. The dopamine rush trains your subconscious to chase hype and ignore fundamentals — building habits that lead to bigger losses down the road.",
            ...
            SelectLevelViewModel.ImageCollection.Add(new LevelModel
            {
                ...
                LearnedByWinMessage = "Learn of Win:The student learned from reading Warren Buffett's books that the greatest investment is in yourself. Knowledge, skills, and mindset are intangible assets that stay with you forever — stored safely in your brain, growing in value over time.",
                LearnedByLoseMessage = "Learn of Lose:The student realized that sometimes a good YouTube video teaches more than a private school professor. In a world where kids are shaped by money but taught little about it, traditional education often produces skilled workers with no financial freedom. It's always better to learn how money works before you start earning it.",
            ...
            SelectLevelViewModel.ImageCollection.Add(new LevelModel
            {
                ...
                LearnedByWinMessage = "Alex learned by this win, that money is important — but reputation is even more important. Always treat people with respect, especially those who support you financially, like family or your bank. A strong reputation and good credit score open doors that money alone can’t.",
                LearnedByLoseMessage = "Alex learned the hard way: never invest long-term using debt, leverage, or other person's money you can’t afford to lose. Always keep 6 to 12 months of living expenses in cash — especially in stable Reserve currencies like the USD ( < 10% inflation /yr). Count that emergency fund as 'UnOwned'.If you don’t have UnOwned money, you may one day lose what you Owned!!",
            ...
            SelectLevelViewModel.ImageCollection.Add(new LevelModel
            {
                ...
                LearnedByWinMessage = "Mira Learned from this win: A little of Something good is better than all of nothing.. if not have an investing plan and not start with small money. Small money will never become big money!",
                LearnedByLoseMessage = "Mira Learned from this lose:In the Ture way, if a Pain not kill you ,It will make you stronger ! Sport habits and a healthy body are an investment. Patients with stronger muscles that hold discs have a lower chance of suffering a herniated disc and recover more easily!",
